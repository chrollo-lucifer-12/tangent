...
const TitleSection:React.FC<TitleSectionProps> = ({title, subheading, pill}) => {
        return <React.Fragment>
            <section className="flex flex-col gap-4 justify-center items-start md:items-center">
                <article className="rounded-full p-[1px] text-sm dark:bg-gradient-to-r dark:from-orange-500 dark:to-yellow-400">
                ...
                {subheading ? (
                    <>
                        ...
                        <p className="dark:text-yellow-400 sm:max-w-[450px] md:text-center">{subheading}</p>
                    </>
                ) : (
